...
window.openDetails = function (carId) {
  ...
  const stockInfoHtml = car.status !== 'sold' && !isOutOfStock && qty <= 3 ? `<span class="car-badge" style="position:relative; top:0; left:0; background: rgba(255,165,0,0.2); border-color: #FFA500; color: #FFA500;">Only ${qty} left!</span>` : '';
